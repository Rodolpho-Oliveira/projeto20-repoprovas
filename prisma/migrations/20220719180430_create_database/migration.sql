...
-- AddForeignKey
ALTER TABLE "tests" ADD CONSTRAINT "tests_teacherDisciplinedId_fkey" FOREIGN KEY ("teacherDisciplinedId") REFERENCES "teachersDisciplines"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
